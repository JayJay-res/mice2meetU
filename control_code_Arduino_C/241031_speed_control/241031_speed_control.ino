...
int PIN_BNC_DOOR = 5;
int PIN_OVERRIDE_DOOR = 6;
int PIN_SERVO_DOOR = 12;
int PIN_POT_DOOR = A7;

int POS_TILT_LOW = 80, POS_TILT_HIGH = 140;
int POS_DOOR_OPEN = 150, POS_DOOR_CLOSE = 30;
...
void loop()
{
  ...
  Serial.print("Override tilt:");
  Serial.println(override_tilt_in);
  Serial.print("Override door:");
  Serial.println(override_door_in);
}
